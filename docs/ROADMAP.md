...
| **Last update** | 2026-05-11 (Closed BEE-82 — release-please + cosign + GH Releases pipeline; first publication on milestone-close PR; net delta 0 days) |
...
- **Story points**: 104 (18 tasks; **91 SP closed**, 13 SP remaining; BEE-2050 + BEE-2220 scope additions)
- **Start**: 2026-04-28 (Tue)
- **End estimate**: 2026-05-18 (Mon)
- **Status**: ✅ En tiempo (17/18 tasks closed — BEE-67..BEE-75 + BEE-77 + BEE-78 + BEE-79 + BEE-80 + BEE-81 + BEE-82 + BEE-2050 + BEE-2220; **only BEE-76 remaining** as milestone closer, scoped down to property tests + coverage report)
